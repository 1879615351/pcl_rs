...
use ros_pointcloud2::points::*;
fn main() {
    let cloud1 =
        load_from_pcd::<PointXYZ>("/home/xxx/projectspace/pcl_rs/pcl_rs/assets/scan3.pcd").unwrap();
    let _ = load_from_pcd::<PointXYZRGB>("/home/xxx/projectspace/pcl_rs/pcl_rs/assets/scan3.pcd")
        .unwrap();
